...
describe("Sweet API Endpoints", () => {
    ...
    describe("GET /api/sweets/search", () => {
        it("should return sweets matching the query", async () => {
            ...
            } as any); // Mocking chainable query
    ...
    describe("PUT /api/sweets/:id", () => {
        it("should update a sweet", async () => {
            ...
            (Sweet.findByIdAndUpdate as jest.Mock).mockResolvedValue(updatedSweet);
    ...
    describe("DELETE /api/sweets/:id", () => {
        it("should delete a sweet", async () => {
            (Sweet.findByIdAndDelete as jest.Mock).mockResolvedValue({ _id: "123" });
